...
const categories = [
  { id: 'materials', label: 'Materials', icon: 'package-variant' },
  { id: 'tools', label: 'Tools', icon: 'hammer-wrench' },
  ...
  { id: 'subscriptions', label: 'Subscriptions', icon: 'calendar-sync' },
  { id: 'maintenance', label: 'Maintenance', icon: 'toolbox' },
...
export default function AddExpenseScreen() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await database.createExpense(expenseData, user.id);
